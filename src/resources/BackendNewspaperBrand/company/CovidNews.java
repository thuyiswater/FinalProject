...
public class CovidNews {
    ...
    public void getZingNewsCovid() throws IOException {

        String link = "https://zingnews.vn/tieu-diem/covid-19-bung-phat-2021.html?src=home_trending";
    ...
    public void getTuoiTreCovid() throws IOException {

        String link = "https://tuoitre.vn/covid-19.html";
        Document doc = Jsoup.connect(link).get();
    ...
    public void getVNExpressCovid() throws IOException {


        String link = "https://vnexpress.net/chu-de/covid-19-tp-hcm-3273";
        Document doc = Jsoup.connect(link).get();
    ...
    public void getThanhNienCovid() throws IOException {

        String link = "https://thanhnien.vn/covid-19/";
        Document doc = Jsoup.connect(link).get();
    ...
    public void getNhanDanCovid() throws IOException {

        String linkserver = "https://nhandan.vn/tag/Covid19-53";
