...
public class SportNews {
    ...
    public void getZingNewsSport() throws IOException {

        String link = "https://zingnews.vn/the-thao.html";
    ...
    public void getTuoiTreSport() throws IOException {

        String link = "https://tuoitre.vn/the-thao.htm";
        Document doc = Jsoup.connect(link).get();
    ...
    public void getVNExpressSport() throws IOException {


        String link = "https://vnexpress.net/the-thao";
        Document doc = Jsoup.connect(link).get();
    ...
    public void getThanhNienSport() throws IOException {

        String link = "https://thanhnien.vn/the-thao/";
        Document doc = Jsoup.connect(link).get();
    ...
    public void getNhanDanSport() throws IOException {

        String linkserver = "https://nhandan.vn/thethao";
