...
public class PoliticNews {
    ...
    public void getZingNewsPolitic() throws IOException {
    ...
    public void getTuoiTrePolitic() throws IOException {

        String link = "https://tuoitre.vn/bo-chinh-tri.html";
        Document doc = Jsoup.connect(link).get();
    ...
    public void getVNExpressPolitic() throws IOException {
    ...
    public void getThanhNienPolitic() throws IOException {

        String link = "https://thanhnien.vn/thoi-su/chinh-tri/";
        Document doc = Jsoup.connect(link).get();
    ...
    public void getNhanDanPolitic() throws IOException {

        String linkserver = "https://nhandan.vn/chinhtri";
